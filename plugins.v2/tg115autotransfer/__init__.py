...
class Tg115AutoTransfer(_PluginBase):
    ...
    def get_form(self) -> Tuple[List[dict], Dict[str, Any]]:
        return [{"component": "VForm", "content": [
            {"component": "VAlert", "props": {"type": "success", "variant": "tonal", "text": "v0.5.0 全新重构：插件按MoviePilot订阅名直接搜索TG公开频道，命中115分享后即时判断、去重、限速转存。只保存必要处理记录用于防重复和失败重试。"}},
            ...
            {"component": "VDivider", "props": {"class": "my-3"}},
            {"component": "VAlert", "props": {"type": "info", "variant": "tonal", "text": "四、电视剧追更"}},
            {"component": "VRow", "content": [
    ...
    def get_page(self) -> Optional[List[dict]]:
        ...
        return [
            {"component": "VAlert", "props": {"type": "success", "variant": "tonal", "text": "v0.5.0：全新直搜版。插件根据MP订阅名直接搜索TG公开频道：t.me/s/频道?q=订阅名。只保存必要处理记录，用于防重复、失败重试和115限速。"}},
