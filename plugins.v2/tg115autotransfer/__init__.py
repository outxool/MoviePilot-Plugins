...
class Tg115AutoTransfer(_PluginBase):
    ...
    plugin_desc = "TG历史资源库、增量扫描、媒体库缺失检查与115限流保护"
    ...
    def get_form(self) -> Tuple[List[dict], Dict[str, Any]]:
        return [{
            "component": "VForm",
            "content": [
                {"component": "VAlert", "props": {"type": "info", "variant": "tonal", "text": "v0.4.0：新增TG历史资源库、历史回填、历史库重匹配、115限流冷却、媒体库/缺失集检查、标题季集增强识别。"}},
                ...
                {"component": "VAlert", "props": {"type": "warning", "variant": "tonal", "text": "115风控建议：单轮最多转存3个、单订阅1个、转存间隔30秒、桥接延迟120秒。触发限流后会进入冷却并停止本轮转存。"}},
                {"component": "VRow", "content": [
                    ...
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "max_transfers_per_subscription", "label": "单订阅上限", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "transfer_delay_seconds", "label": "转存间隔秒数", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "p115_cooldown_minutes", "label": "115冷却分钟", "type": "number"}}]},
                ]},
                {"component": "VRow", "content": [
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "stop_on_rate_limit", "label": "限流后停止本轮"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VTextField", "props": {"model": "bridge_delay_seconds", "label": "桥接延迟秒数", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VTextField", "props": {"model": "request_timeout", "label": "请求超时秒数", "type": "number"}}]},
                ]},
                {"component": "VDivider", "props": {"class": "my-3"}},
                {"component": "VAlert", "props": {"type": "success", "variant": "tonal", "text": "历史资源库：首次分批抓TG可见历史，默认只入库不自动转存；新增订阅后可点“重新匹配历史库”。"}},
                {"component": "VRow", "content": [
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VSwitch", "props": {"model": "history_enabled", "label": "启用历史资源库"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VSwitch", "props": {"model": "auto_backfill_history", "label": "自动历史回填"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VSwitch", "props": {"model": "backfill_transfer_enabled", "label": "回填时自动转存"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VSwitch", "props": {"model": "history_auto_transfer", "label": "历史命中自动转存"}}]},
                ]},
                {"component": "VRow", "content": [
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "backfill_pages_per_run", "label": "每轮回填页数", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "backfill_resources_per_run", "label": "每轮历史资源", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "backfill_page_delay_seconds", "label": "回填页间隔", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "history_match_limit", "label": "每轮匹配数量", "type": "number"}}]},
                ]},
                {"component": "VDivider", "props": {"class": "my-3"}},
                {"component": "VAlert", "props": {"type": "info", "variant": "tonal", "text": "媒体库/缺失检查：电影已存在跳过；剧集默认只转存订阅缺失集；无法识别季集时不自动转存，进入需要确认。"}},
                {"component": "VRow", "content": [
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "check_media_exists", "label": "转存前检查媒体库"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "only_missing", "label": "只转存缺失内容"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "skip_existing_movie", "label": "电影已有则跳过"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "tv_only_missing_episodes", "label": "电视剧只转存缺集"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "auto_transfer_unknown_episode", "label": "未知季集也转存"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "skip_low_quality", "label": "跳过枪版低质"}}]},
                ]},
                {"component": "VRow", "content": [
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VTextField", "props": {"model": "minimum_score", "label": "当前页最低分", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VTextField", "props": {"model": "history_minimum_score", "label": "历史匹配最低分", "type": "number"}}]},
                    {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VTextField", "props": {"model": "retry_limit", "label": "失败重试上限", "type": "number"}}]},
                ]},
                {"component": "VRow", "content": [
    ...
    def get_page(self) -> Optional[List[dict]]:
        ...
        for item in history_stats.get("channels", []):
            channel_lines.append(
                f"{item.get('channel')}: 最新ID {item.get('newest_id')}，已回填到 {item.get('oldest_id')}，完成={'是' if item.get('backfill_complete') else '否'}，资源 {item.get('total_resources')}"
            )
        channel_text = "\n".join(channel_lines) or "暂无频道回填记录"
        return [
            {"component": "VAlert", "props": {"type": "info", "variant": "tonal", "text": "TG115自动转存 v0.4.0：历史资源库 + 115限流保护 + 媒体库缺失检查。建议先仅日志演练，再逐步开启真实转存。"}},
            ...
            {"component": "VCard", "props": {"variant": "outlined", "class": "mb-2"}, "content": [
                ...
                {"component": "VCardText", "text": " ｜ ".join(f"{key}: {value}" for key, value in status.items() if key not in {"history_by_status"})},
            ]},
            {"component": "VCard", "props": {"variant": "outlined", "class": "mb-2"}, "content": [
                {"component": "VCardTitle", "text": "历史库统计"},
                {"component": "VCardText", "text": f"资源：{history_stats.get('resources', 0)} ｜ 链接：{history_stats.get('links', 0)} ｜ 待匹配：{by_status.get(STATUS_PENDING, 0)} ｜ 已匹配：{by_status.get(STATUS_MATCHED, 0)} ｜ 已转存：{by_status.get(STATUS_TRANSFERRED, 0)} ｜ 已有跳过：{by_status.get(STATUS_EXISTING, 0)} ｜ 需确认：{by_status.get(STATUS_NEED_CONFIRM, 0)} ｜ 失败：{by_status.get(STATUS_FAILED, 0)}"},
            ]},
            {"component": "VCard", "props": {"variant": "outlined", "class": "mb-2"}, "content": [
                {"component": "VCardTitle", "text": "频道回填进度"},
