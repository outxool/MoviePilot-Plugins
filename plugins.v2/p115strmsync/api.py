...
class Api:
    ...
    def __init__(self, client: Optional[P115Client]):
        ...
        self.browse_dir_pan_api_cache = TTLCache(
            maxsize=1024, ttl=120, region="p115strmsync_api_browse_dir_api"
        )
    ...
    def generate_media_redirect_config_api(
        ...
        try:
            ...
            redirect_url = f"{base_url}/api/v1/plugin/P115StrmSync/redirect_url"
    ...
    @cached(
        region="p115strmsync_api_get_user_storage_status", ttl=60 * 60, skip_none=True
    )
