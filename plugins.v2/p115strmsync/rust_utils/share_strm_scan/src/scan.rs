...
mod tests {
    ...
    fn process_multiline_dedup_in_file() {
        let s = b"http://x/P115StrmSync?share_code=a&receive_code=b\nhttp://x/P115StrmSync?share_code=a&receive_code=b\n";
    ...
    fn scan_index_nested_two_strm_one_pair() {
        ...
        let url = "http://127.0.0.1:3000/api/v1/plugin/P115StrmSync/redirect_url?share_code=sc1&receive_code=r1&id=99";
