                        ...
                        'content': [{
                            ...
                            'content': [{
                                ...
                                'props': {
                                    'type': 'info',
                                    'variant': 'tonal',
                                    'text': '自动搜索115网盘资源并转存缺失的电影和剧集，需配置115 Cookie和搜索服务。魔改版已解除原版8小时固定周期限制，Cron 最小间隔为 1 小时。'
                                }
                            }]
                        }]
                    },
                        ...
                        'content': [
                            {
                                ...
                                'content': [{
                                    ...
                                    'events': {
                                        'click': {
                                            'api': f'/plugin/P115StrgmSubMod/sync_subscribes?apikey={settings.API_TOKEN}',
                                            'method': 'get'
                                        }
                                    }
                                }]
                            },
                            {
                                ...
                                'content': [{
                                    ...
                                    'events': {
                                        'click': {
                                            'api': f'/plugin/P115StrgmSubMod/clear_history?apikey={settings.API_TOKEN}',
                                            'method': 'post'
                                        }
                                    }
                                }]
